...
class NotificationRemoteDataSource {
  ...
  Future<Map<String, dynamic>> listNotifications({
    ...
    final uri = Uri.parse('$_baseUrl/candidate/notifications')
  ...
  Future<void> markAsRead(String notificationId) async {
    final uri = Uri.parse('$_baseUrl/candidate/notifications/$notificationId/read');
  ...
  Future<void> archive(String notificationId) async {
    final uri = Uri.parse('$_baseUrl/candidate/notifications/$notificationId/archive');
    final response = await _client.patch(uri, headers: await _headers());
    _decodeResponse(response);
  }
  ...
  Map<String, dynamic> _decodeResponse(http.Response response) {
    ...
    if (response.statusCode < 200 || response.statusCode >= 300) {
      final message = decoded is Map<String, dynamic>
          ...
          : null;
      throw Exception(message ?? 'Notification request failed (${response.statusCode})');
    }
