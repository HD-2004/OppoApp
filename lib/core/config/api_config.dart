...
String resolveUrl(String originalUrl) {
  if (isLocalWeb) {
    ...
    if (originalUrl.contains('l1636ie205.execute-api.ap-southeast-1.amazonaws.com/applications')) {
      return originalUrl.replaceFirst(
        'https://l1636ie205.execute-api.ap-southeast-1.amazonaws.com/applications',
        'http://localhost:3000/api-applications',
      );
    }
    if (originalUrl.contains('l1636ie205.execute-api.ap-southeast-1.amazonaws.com')) {
      return originalUrl.replaceFirst(
    ...
    if (originalUrl.contains('iuo7ofruu6.execute-api.ap-southeast-1.amazonaws.com')) {
      return originalUrl.replaceFirst(
    ...
    if (originalUrl.contains('v56v542h8f.execute-api.ap-southeast-1.amazonaws.com/prod')) {
      return originalUrl.replaceFirst(
    ...
    if (originalUrl.contains('dlidp35x33.execute-api.ap-southeast-1.amazonaws.com/prod')) {
      return originalUrl.replaceFirst(
    ...
    if (originalUrl.contains('xyp4wkszi7.execute-api.ap-southeast-1.amazonaws.com/prod/candidates')) {
      return originalUrl.replaceFirst(
        'https://xyp4wkszi7.execute-api.ap-southeast-1.amazonaws.com/prod/candidates',
        'http://localhost:3000/api',
      );
    }
    if (originalUrl.contains('xyp4wkszi7.execute-api.ap-southeast-1.amazonaws.com/prod')) {
      return originalUrl.replaceFirst(
